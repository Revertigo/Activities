...
public Activity(long id,String name,String Type,Address addr,String difficulty,boolean single_group,Gender gender,String description, Date date, String time){
    ...
    public static class Address
    {
        ...
        public String getCity(){ return this.city_set;}
        public String getStreet(){return this.street;}
        public String getApartNumString(){return Integer.toString(this.apartment_number);}
        public int getApartNumInt(){return this.apartment_number;}
    }
public String[] getData(){
       data_array[0]=Float.toString(this.id); // the id of the activity
       ...
       data_array[7]="true";}//group
       else{data_array[7]="false";} //singe
       if(gender.equals(0)){//gender of the activity
       data_array[8]="female";}
       else if(gender.equals(1)){data_array[8]="male";}//gender of the activity
       else{data_array[8]="both";} //gender of the activity
   ...
   public String getName(){return this.name;}
    ...
    public void setSingle_Group(boolean ans){this.single_group=ans;}
    public boolean getSingle_Group(){return this.single_group;}
